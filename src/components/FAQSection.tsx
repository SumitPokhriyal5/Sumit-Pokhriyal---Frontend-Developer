...
const FAQSection = () => {
  ...
  return (
    <div className="bg-[#0B0A0B] w-11/12 m-auto flex flex-col items-center text-white">
      ...
      <div className="flex max-[1200px]:flex-col items-center gap-[5rem] w-[100%]">
        <div ref={leftDivRef} className="w-[40%] max-[1200px]:w-11/12 flex justify-center items-center">
          <img
            width={"100%"}
            height={"auto"}
            src={"/faq-logo.png"}
        ...
        <div ref={rightDivRef} className="items-center justify-center w-[50%] max-[1200px]:w-11/12 flex flex-col gap-5 text-[1rem] max-[700px]:text-[0.6rem] font-shojumaru">
          <details className="transition duration-300 ease h-fit w-[100%] border-[1px] border-[#ED0137] rounded-[20px] p-[1rem] max-[700px]:p-[0.6rem]">
            <summary className="flex justify-between items-center text-center p-[0px_1rem] cursor-pointer w-[100%] ">
              <p>1</p>
            ...
            <div className="bg-[#181818] text-white p-[1rem_2rem] rounded-[2rem] mt-[2.5rem]">
              <p className="leading-[1rem] font-zcool">
          ...
          <details className="transition duration-300 ease h-fit w-[100%] border-[1px] border-[#ED0137] rounded-[20px] p-[1rem] max-[700px]:p-[0.6rem]">
            <summary className="flex justify-between items-center text-center p-[0px_1rem] cursor-pointer">
              <p>2</p>
              <p className="text-left self-center">
            ...
            <div className="bg-[#181818] text-white p-[1rem_2rem] rounded-[2rem] mt-[2.5rem] w-[100%] ">
              <p className="leading-[1rem] font-zcool">
                Lorem ipsum dolor sit amet consectetur, adipisicing.
